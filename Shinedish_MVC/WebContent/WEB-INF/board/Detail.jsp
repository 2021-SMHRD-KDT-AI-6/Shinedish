...
-->
		...
		<div id="mainpage">
			...
			<!-- Page rst_button -->
			<div id="rst_button">
				<li style="display: inline-block;"><span><a href="#"><button
								class="rst_button_name" id="rst_pick" type="button">찜하기</button></a></span>
					<span><a href="#"><button class="rst_button_name"
								id="rst_review" type="button">리뷰쓰기</button></a></span></li>
			</div>
			...
			<div id="review">
				...
				<div class="review_box">
					...
					<div class="review_star">
						<small id="stsc" class="text-muted">&#9733; &#9733;
							&#9733; &#9733; &#9734;</small>
					</div>
				</div>
		...
		$('#choice').on('click', function(){
			...
			// location > 현재 위치
			window.location = "choice.do?r_addr_gu=" + formData.location + "&choice.do?mood_num=" + formData.mood;
