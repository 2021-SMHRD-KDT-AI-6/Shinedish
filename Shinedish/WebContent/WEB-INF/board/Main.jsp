...
<body>
	<div id="home">
		...
		<div id="header"
			style="padding: 5px; margin: 5px; display: grid; grid-template-columns: 1.5fr 1.5fr 2fr;">
		...
		<div id="mainpage">
			...
			<div id="recommend_food">
				<!-- 
			<span>오늘은 "화요일"입니다. </span> 
 -->
			<script type="text/javascript">
				var d = new Date();
				var week = new Array('일', '월', '화', '수', '목', '금', '토');
				var D = week[d.getDay()];
				document.write('<br><h1 id="recommend_food">오늘은 "' + D + '요일" 입니다.'+ '</h1>');
			</script>
				<span>오늘 저녁 이런 음식은 어떤가요?</span>
			</div>
					...
					<div class="card-body" style="height: 230px">
						...
						<p align="center">
							<a href="<%=cpath%>/detail.do?r_num=<%=vo.getR_num()%>"
								...
								style="position: absolute; left: 135px; bottom: 35px;">상세보기</a>
						</p>
						<br>
					</div>
